...
*	with Informix stored procedures. Generates stored procedure calls of form
*	<BR><BR>
...
public abstract class DataCollectionInformix extends DataCollectionProc
{
	/******************************************************************************
	*
	* Static constants
	...
	*/
	protected DataCollectionInformix(ConnectionFactory pConnectionFactory)
	{
	...
	******************************************************************************/
	...
	/** Returns the default Informix prefix for stored procedures of "usp".
		@return Returns a string.
	*/
	protected String getPrefix() { return PREFIX; }

	/** Returns the default Informix separator for stored procedures of "_".
		@return Returns a string.
	*/
